...
def new_head_process():
    ...
    trigger_op_1 = TriggerDagRunOperator(
        task_id='target_dag_trigger1',
    ...
    trigger_op_2 = TriggerDagRunOperator(
        task_id='target_dag_trigger2',
        trigger_dag_id='target_dag_example',
        wait_for_completion=True,
        poke_interval=5,
        max_active_tis_per_dag=1,
    ...
    trigger_op_3 = TriggerDagRunOperator(
        task_id='target_dag_trigger3',
        trigger_dag_id='target_dag_example',
        wait_for_completion=True,
        poke_interval=5,
        max_active_tis_per_dag=1,
    ...
    (
        init_run_id() >>
        trigger_op_1 >> [trigger_op_2, trigger_op_3] >>
        finish_etl_run()
    )
