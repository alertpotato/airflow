...
DESCRIPTION = '''
Модель риска несвоевременного обращения за медицинской помощью
...
Задача: [jira]\ 
(https://jira.element-lab.ru/browse/KMP-1582)

Вики: [wiki.element-lab]\
(https://wiki.element-lab.ru/pages/viewpage.action?pageId=49548497)
'''
...
ML_MODEL_NAME = 'model_weak_examination'
