...
DESCRIPTION = '''
Модель риска возникновения инсульта
...
Задача: [jira]\
(https://jira.element-lab.ru/browse/KMP-1358)
...
ML_MODEL_NAME = 'model_risk_smerty_insult'
...
TASKS = [
    ...
    ('process_features_data', 'process_features_data/main.py'),
