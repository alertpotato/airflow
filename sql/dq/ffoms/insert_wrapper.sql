...
insert into dq.log_dq_err (document_load_id, etl_proc_id, doc_ods_id, src_ods_id,table_id, rule_id, column_name, column_value, insert_dttm, err_status_cd)
select
    ...
    ,'{{ params.err_status_cd }}' as err_status_cd
from
    errors as err
