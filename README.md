Это основной репозиторий оркестратора ETL-процессов для проектов ФФОМС. Здесь храняться ДАГи всех проектов, общие функциональные модули и в некоторых случаях sql-скрипты. Репозиторий синхронизирован с тестовым и продуктивным сервером(ветки master & production соответственно).
...
## Support
По общим вопросам ETL можно обращаться к Сударикову Арсению и Андрею Иванову. По техническим тонкостям работы фреймворка ответственный Юрий Копылов. По вопросам проекта ЦМП - Дмитрий Григорьев. Руководитель проекта Евгений Морозов. Технический руководитель Михаил Александров. 

## Roadmap
- Январь: утверждение окончательных принципов и подходов в разработке дагов.
- Февраль: первая часть процессов сбора витрин данных и интеграций с подсистемами
- Март: разработка модуля dq

## Authors and acknowledgment
Над проектом работали: Арсений Судариков(asudarikov@rtk-element.ru), Юрий Копылов(ukopilov@rtk-element.ru), Андрей Иванов(aivanov@rtk-element.ru), Дмитрий Григорьев(dgrigorev@rtk-element.ru).
